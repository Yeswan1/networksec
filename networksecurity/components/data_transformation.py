...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered the data_transformer_object of transformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"Intialize KNNImputer {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("enterd intiate data transformation method of DataTransformation class")
        try:
